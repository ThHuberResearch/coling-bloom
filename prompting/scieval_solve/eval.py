...
def main(
    ...
    for category in category_judge.keys():
        ...
        for i in range(len(category_j)):
            ...
            print(category, index_ability[i], category_j[i] / category_n[i])
...
if __name__ == '__main__':
    main('/home/thomas/PycharmProjects/bloom_taxonomy_emnlp/prompting/scieval_solve/outputs/llama3_output.json')