...
for model in models:
    ...
    with open(os.path.join(current_dir, 'output_commonsense_qa', f'{model}_cognitive.json'), 'w') as f:
        json.dump(out_cognitive, f)
    with open(os.path.join(current_dir, 'output_commonsense_qa', f'{model}_knowledge.json'), 'w') as f:
